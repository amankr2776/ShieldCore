...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="font-body antialiased bg-white dark:bg-[#020408] text-gray-900 dark:text-foreground min-h-screen flex flex-col transition-colors duration-300">
        <LoadingScreen />
        <AuthProvider>
